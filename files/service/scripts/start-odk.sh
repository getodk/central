...
envsubst '$DOMAIN:$HTTPS_PORT:$SYSADMIN_EMAIL:$ENKETO_API_KEY:$DB_HOST:$DB_USER:$DB_PASSWORD:$DB_NAME:$EMAIL_NO_REPLY:$EMAIL_HOST:$EMAIL_PORT:$EMAIL_SECURE:$EMAIL_IGNORE_TLS:$EMAIL_USER:$EMAIL_PASSWORD:$SENTRY_ORG_SUBDOMAIN:$SENTRY_KEY:$SENTRY_PROJECT' \
