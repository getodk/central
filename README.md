...
9. Now you'll need to download the software. In the server window, type `git clone https://github.com/nafundi/effective-spork .` (that's a space followed by a period at the end) and press **Enter**. It should think for some time and download many things.
